                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex;">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('setting-restore')): ?>
                                                        <a class="btn btn-outline-primary-2x" style="margin:0 20px;"
                                                            href="<?php echo e(route('settings.restore', $setting->id)); ?>"><?php echo e(__('master.restore')); ?></a>
                                                    <?php endif; ?>

                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('setting-forceDelete')): ?>
                                                        <form action="<?php echo e(route('settings.forceDelete', $setting->id)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <input style="border-color: #d22d3d;"
                                                                ...
                                                                onclick="return confirm('<?php echo e(__('setting.forcedelete_warning')); ?> \n (<?php echo e($setting->user->name); ?>)')">
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <div class="alert alert-secondary text-center h5"><?php echo e(__('setting.empty_deleted_foresle_msg')); ?></div>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kemia-project\resources\views/dashboard/settings/delete.blade.php ENDPATH**/ ?>