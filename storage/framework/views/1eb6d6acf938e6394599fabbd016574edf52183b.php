                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text" required=""
                                        name="name" placeholder="ex: Mohamed Samy" value="<?php echo e(old('name')); ?>" />
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\kemia-project\resources\views/dashboard/users/create.blade.php ENDPATH**/ ?>