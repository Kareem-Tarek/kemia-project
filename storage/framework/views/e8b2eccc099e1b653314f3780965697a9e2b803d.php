                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <form class="needs-validation" novalidate="" id="alert-form" method="post" action="<?php echo e(route('categories.store')); ?>"
                                    ...
                                    <div class="tab-pane fade mt-4 <?php if(LaravelLocalization::getCurrentLocale() == 'ar'): ?> show active <?php endif; ?>" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label" for="validationCustom01"><?php echo e(__('category.name')); ?> <span class="text-danger">*</span></label>
                                                <input class="form-control" id="validationCustom01" type="text" required=""
                                                    name="name_ar" placeholder="مثل: إلكترونيات" value="<?php echo e(old('name_ar')); ?>" />
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\kemia-project\resources\views/dashboard/categories/create.blade.php ENDPATH**/ ?>