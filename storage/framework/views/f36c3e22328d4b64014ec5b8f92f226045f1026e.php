            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" method="post" action="<?php echo e(route('settings.update', $setting->id)); ?>"
                                ...
                                <div class="tab-pane fade mt-4 <?php if(LaravelLocalization::getCurrentLocale() == 'en'): ?> show active <?php endif; ?>" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input class="form-control" id="validationCustom01" type="text" required=""
                                                    name="title_en" placeholder="ex: Black shirt" value="<?php echo e(Request::old('title_en') ? Request::old('title_en') : $setting->getTranslation( 'title', 'en' )); ?>" />
                                        ...
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control" id="validationCustom01"
                                                    name="description_en" placeholder="ex: color, size, about setting" value="<?php echo e(Request::old('description_en') ? Request::old('description_en') : $setting->getTranslation( 'description', 'en' )); ?>"> </textarea>
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control" id="validationCustom01"
                                                    name="short_description_en" placeholder="ex: color, size, about setting" value="<?php echo e(Request::old('short_description_en') ? Request::old('short_description_en') : $setting->getTranslation( 'short_description', 'en' )); ?>"> </textarea>
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade mt-4 <?php if(LaravelLocalization::getCurrentLocale() == 'ar'): ?> show active <?php endif; ?>" id="ar" role="tabpanel" aria-labelledby="ar-tab">
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label" for="validationCustom01"><?php echo e(__('setting.title')); ?> <span class="text-danger">*</span></label>
                                                <input class="form-control" id="validationCustom01" type="text" required=""
                                                    name="title_ar" placeholder="ex: Black shirt" value="<?php echo e(Request::old('title_ar') ? Request::old('title_ar') : $setting->getTranslation( 'title', 'ar' )); ?>" />
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label" for="validationCustom01"><?php echo e(__('setting.description')); ?></label>
                                                <textarea class="form-control" id="validationCustom01"
                                                    name="description_ar" placeholder="ex: color, size, about setting" value="<?php echo e(Request::old('description_ar') ? Request::old('description_ar') : $setting->getTranslation( 'description', 'ar' )); ?>"> </textarea>
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-1">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label" for="validationCustom01"><?php echo e(__('setting.short_description')); ?></label>
                                                <textarea class="form-control" id="validationCustom01"
                                                    name="short_description_ar" placeholder="ex: color, size, about setting" value="<?php echo e(Request::old('short_description_ar') ? Request::old('short_description_ar') : $setting->getTranslation( 'short_description', 'ar' )); ?>"> </textarea>
                                                <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                                <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                            </div>
                                        </div>
                            ...
                            <div class="row g-1">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="user_id" class="form-control" value="<?php echo e(Request::old('user_id') ? Request::old('user_id') : $setting->user_id); ?>" required>
                                        <option value="" selected>No users selected </option>
                                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($user->id); ?>" <?php echo e($user->id == $setting->user_id ? 'selected'  : ''); ?>><?php echo e($user->name); ?></option>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="phone" placeholder="ex: +201110000 " value="<?php echo e(Request::old('phone') ? Request::old('phone') : $setting->phone); ?>" required/>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="phone2" placeholder="ex: +201110000 " value="<?php echo e(Request::old('phone2') ? Request::old('phone2') : $setting->phone2); ?>"/>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="email" placeholder="ex: example@email.com " value="<?php echo e(Request::old('email') ? Request::old('email') : $setting->email); ?>" required/>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="whatsApp" placeholder="ex: +201110000 " value="<?php echo e(Request::old('whatsApp') ? Request::old('whatsApp') : $setting->whatsApp); ?>" required/>
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="facebook" placeholder="ex: https://www.facebook.com " value="<?php echo e(Request::old('facebook') ? Request::old('facebook') : $setting->facebook); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="twitter" placeholder="ex: https://twitter.com/ " value="<?php echo e(Request::old('twitter') ? Request::old('twitter') : $setting->twitter); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom01" type="text"
                                        name="instagram" placeholder="ex: https://instagram.com/ " value="<?php echo e(Request::old('instagram') ? Request::old('instagram') : $setting->instagram); ?>" />
                                    <div class="valid-feedback"><?php echo e(__('validation.valid_feedback')); ?></div>
                                    <div class="invalid-feedback"><?php echo e(__('validation.invalid_feedback')); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\kemia-project\resources\views/dashboard/settings/edit.blade.php ENDPATH**/ ?>